    ...
    <div class="container-fluid container-md">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-7 try-soter__left">
                ...
                <div class="try-soter__reasons">
                    <h3>Why Trial?</h3>
                    <div class="try-soter__reasons-item">
                        <div class="item-icon">
                            <img src="./assets/img/try-soter/time-icon.svg" alt="Иконка">
                        </div>
                        <div class="item-text">
                            <h4>Fast</h4>
                            <p>Implement the trial in less than one hour for dozens of workers.
                            </p>
                        </div>
                    </div>
                    <div class="try-soter__reasons-item">
                        <div class="item-icon">
                            <img src="./assets/img/try-soter/arrow-icon.svg" alt="Иконка">
                        </div>
                        <div class="item-text">
                            <h4>Change management</h4>
                            <p>A limited trial will help with change management and product acceptance.</p>
                        </div>
                    </div>
                    <div class="try-soter__reasons-item">
                        <div class="item-icon">
                            <img src="./assets/img/try-soter/worker-icon.svg" alt="Иконка">
                        </div>
                        <div class="item-text">
                            <h4>Self-managed</h4>
                            <p>Worker drives the improvement process, manager intervention is required only by exception.</p>
                        </div>
                    </div>
                    <div class="try-soter__reasons-item">
                        <div class="item-icon">
                            <img src="./assets/img/try-soter/risk-icon.svg" alt="Иконка">
                        </div>
                        <div class="item-text">
                            <h4>Reduce risk</h4>
                            <p>Minimize cost exposure while the benefits are demonstrated</p>
                        </div>
                    </div>
                </div>
            </div>
